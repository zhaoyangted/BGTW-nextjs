										...
										<div className={id ? "tab-pane fade active show" : "tab-pane fade "}>
											...
											<div className="container">
												<div className="col-lg-">
													...
													<form action={process.env.apiServer+"/api/member/check/pay/" + id} method="post" onSubmit={submitForm}>
														<ul className={styles.styled_input}>
															...
															<li className={styles.half}>
																<h2>帳號末五碼*</h2>
																<input type="text" name="d_remit_account" maxlength="5" onChange={handleInput} />
															</li>
															<li className={styles.half}>
																<h2>匯款金額*</h2>
																<input type="text" name="d_remit_price" onChange={handleInput} />
															</li>
															<li>
																<h2>匯款時間*</h2>
																<input type="text" name="d_remit_time" id="d_remit_time" onChange={handleInput} />
															</li>
															<div className={styles.join_line}></div>
