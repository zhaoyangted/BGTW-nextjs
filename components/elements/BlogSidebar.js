		...
		<>
			<div className="widget-area">
				...
				<div className="sidebar-widget widget-category-2 mb-50">
					<h5 className="section-title style-1 mb-30">分類</h5>
					<ul>
						{data
							? data.map((item, i) => {
									return (
										<li style={{ color: `${item.d_color}` }} key={i}>
											<Link href={{
                                                    pathname: '/news/',
                                                    query: { id: item.d_id },
                                                }}
                    ...
                    <li>
                        <Link href="/products"> <img src="/assets/imgs/theme/icons/category-2.svg" alt="" />Clothing</Link><span className="count">35</span>
                    </li>
                    <li>
                        <Link href="/products"> <img src="/assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods</Link><span className="count">42</span>
                    </li>
                    <li>
                        <Link href="/products"> <img src="/assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</Link><span className="count">68</span>
                    </li>
                    <li>
                ...
                <div className="single-post clearfix">
                    ...
                    <div className="content pt-10">
                        <h5><Link href="/shop-product-detail">Chen Cardigan</Link></h5>
                ...
                <div className="single-post clearfix">
                    ...
                    <div className="content pt-10">
                        <h6><Link href="/products">Chen Sweater</Link></h6>
                ...
                <div className="single-post clearfix">
                    ...
                    <div className="content pt-10">
                        <h6><Link href="/products">Colorful Jacket</Link></h6>
                ...
                <div className="single-post clearfix">
                    ...
                    <div className="content pt-10">
                        <h6><Link href="/products">Lorem, ipsum</Link></h6>
                        <p className="price mb-0 mt-5">$25</p>
                        <div className="product-rate">
                            <div className="product-rating" style={{ "width": "60%" }}></div>
                        </div>
            ...
            <div className="sidebar-widget widget_instagram mb-50">
                ...
                <div className="instagram-gellay">
                    <ul className="insta-feed">
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-1.jpg" alt="" /></Link>
                        </li>
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-2.jpg" alt="" /></Link>
                        </li>
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-3.jpg" alt="" /></Link>
                        </li>
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-4.jpg" alt="" /></Link>
                        </li>
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-5.jpg" alt="" /></Link>
                        </li>
                        <li>
                            <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-6.jpg" alt="" /></Link>
                        </li>
                    </ul>
                </div>
            </div>
